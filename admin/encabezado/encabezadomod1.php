...
//2.Preparar la consulta SQL
	...
	$consulta ="SELECT * FROM encabezado WHERE encabezadoID='$codigo'";
//3.Ejecutr esa consulta en la base
	if($datos= mysqli_query($conexion,$consulta)){
		$fila=mysqli_fetch_array($datos);
		$encabezadoID=$fila["encabezadoID"];
...
?>
<form method="post" action="updateencabezado.php">



<ul>
<li><label for="encabezadoID">encabezadoID</li></br>
<input type="hidden" name="encabezadoID"  value="<?php echo $encabezadoID; ?>" />
<br>
