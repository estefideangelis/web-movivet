...
//2.Preparar la consulta SQL
	...
	$consulta ="SELECT * FROM inicioSesion WHERE textoID='$codigo'";
...
echo"<ul><li><a href='inicioSesion.php'>Volver</a> </li></ul>";
...
?>
<form method="post" action="updateinicioSesion.php">
