...
<body>
	<h1>Modificar registroUsuario</h1>
	<?php
...
//2.Preparar la consulta SQL
	...
	$consulta ="SELECT * FROM registroUsuario WHERE textoID='$codigo'";
...
echo"<ul><li><a href='registroUsuario.php'>Volver</a> </li></ul>";
...
?>
<form method="post" action="updateregistroUsuario.php">
