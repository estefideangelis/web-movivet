...
//2.Preparar la consulta SQL
	$consulta ="SELECT*FROM sesionAdmin";
...
/*echo'<td>'.$fila['URLimagen'].'</td>';*/
	echo'<td><a href="sesionAdmin1.php?codaborrar='.$fila['textoID'].'">Borrar</a></td>';
  echo'<td><a href="sesionAdminmod1.php?codamodif='.$fila['textoID'].'">Modificar</a></td>';
	echo"</a></tr>\n";
    echo"</center>";
