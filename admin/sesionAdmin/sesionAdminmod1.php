...
//2.Preparar la consulta SQL
	...
	$consulta ="SELECT * FROM sesionAdmin WHERE textoID='$codigo'";
...
echo"<ul><li><a href='sesionAdmin.php'>Volver</a> </li></ul>";
...
?>
<form method="post" action="updatesesionAdmin.php">
