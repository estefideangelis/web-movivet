...
<body id="page-top">
 ...
 <div><p><?php echo $encabezado_1 ?> </p></div>
   <ul class="nav navbar-nav navbar-right"><li><a class="page-scroll" href="<?php echo $encabezadolinks_4?>"><?php echo $encabezado_4 ?></a></li><li><a class="page-scroll" href="<?php echo $encabezadolinks_5?>"><?php echo $encabezado_5 ?></a></li><li><a class="page-scroll" href="#" >ES</a></li><li><a class="page-scroll" href="#" >EN</a></li></ul>
      ...
      <header style="background-image:url(http://www.movivet.tk/admin/img/header.jpg);"> 
   <section id="home">
   <?php @require 'content/home.php'; ?>
      <?php @require 'content/homelinks.php'; ?>
   <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="header-content col-sm-7">
            ...
            <div id="home-1" class="header-content-inner">
             
           
               <div> <h1><?php echo $home_1 ?> </h1> </div>
                
               <div> <p> <?php echo $home_2 ?> </p>  </div>
                <a href="<?php echo $homelinks_7 ?>" class="btn btn-primary btn-xl page-scroll"><?php echo $home_7?></a>
            </div>
            </div>
  ...
  <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                <div> <h2> <?php echo $home_4 ?></h2>  </div>
                <a href="<?php echo $homelinks_5 ?>" class="btn btn-default btn-xl sr-button"><?php echo $home_5 ?> </a>
            </div>
        </div>
    </aside>
