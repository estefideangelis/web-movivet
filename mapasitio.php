 ...
 <div><p><?php echo $encabezado_1 ?> </p></div>
   <ul class="nav navbar-nav navbar-right"><li><a class="page-scroll" href="<?php echo $encabezadolinks_4?>"><?php echo $encabezado_4 ?></a></li><li><a class="page-scroll" href="<?php echo $encabezadolinks_5?>"><?php echo $encabezado_5 ?></a></li><li><a class="page-scroll" href="#" >ES</a></li><li><a class="page-scroll" href="#" >EN</a></li></ul>
          ...
          <div class="navbar-header">
              ...
              <div> <a href="index.php"  class="page-scroll img-responsive" ><img src="http://www.movivet.tk/admin/img/Movivet.png"  class="img-responsive navbar-brand page-scroll logo logo-1"/></a></div>
                 </div>
      ...
      <header> 
  <center> <section id="home" style="margin-top:10%;">
  <ul> 
    <li><a href="http://movivet.tk/index.php">HOME</a> </li>
    <li><a href="http://movivet.tk/nosotros.php">NOSOTROS</a> </li>
    <li><a href="http://movivet.tk/servicios.php">SERVICIOS</a> </li>
     <li><a href="http://movivet.tk/baños.php">Baños</a> </li>
      <li><a href="http://movivet.tk/peluqueria.php">Peluqueria</a> </li>
       <li><a href="http://movivet.tk/alimentos.php">Alimentos</a> </li>
        <li><a href="http://movivet.tk/productos.php">Productos</a> </li>
    <li><a href="http://movivet.tk/reservar.php">RESERVA</a> </li>
    <li><a href="http://movivet.tk/movivet-tienda.tk">TIENDA</a> </li>
    <li><a href="http://movivet.tk/galeria.php">GALERIA</a> </li>
    <li><a href="http://movivet.tk/contacto.php">CONTACTO</a> </li>
    <li><a href="http://movivet.tk/sesion.php">INICIO SESION</a> </li>
    <li><a href="http://movivet.tk/registro.php">REGISTRO USUARIO</a> </li>
    <li><a href="http://movivet.tk/administrador.php">SESION ADMINISTRADOR</a> </li>
