        ...
        <div class="container">
            <div class="row">
                ...
                <?php @require 'content/nosotros.php'; ?>
                    <?php @require 'content/nosotroslinks.php'; ?>
                    
                    
                    <div class="section-heading"><h2 class="margin"><?php echo $nosotros_1 ?></h2> </div>
                    <hr class="light">
                     <div class="text-faded"><p><?php echo $nosotros_2 ?></p></div>
                    <a href="<?php echo $nosotroslinks_3?>" class="page-scroll btn btn-default btn-xl sr-button"> <div><?php echo $nosotros_3 ?></div></a>
                </div>
            </div>
        </div>
    </section>
  ...
  <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                <div> <h2> <?php echo $nosotros_4 ?></h2>  </div>
                <a href="<?php echo $nosotroslinks_5 ?>" class="btn btn-default btn-xl sr-button"><?php echo $nosotros_5 ?> </a>
            </div>
        </div>
    </aside>
