...
<body id="page-top">
 ...
 <div><p><?php echo $encabezado_1 ?> </p></div>
   <ul class="nav navbar-nav navbar-right"><li><a class="page-scroll" href="<?php echo $encabezadolinks_4?>"><?php echo $encabezado_4 ?></a></li><li><a class="page-scroll" href="<?php echo $encabezadolinks_5?>"><?php echo $encabezado_5 ?></a></li><li><a class="page-scroll" href="#" >ES</a></li><li><a class="page-scroll" href="#" >EN</a></li></ul>
      ...
      <header style="background-image:url(http://www.movivet.tk/admin/img/reservar.jpg);" id="header-1"> 
   <section id="home">
   
    <?php @require 'content/reservar.php'; ?>
    <?php @require 'content/reservarlinks.php'; ?>
   ...
   <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="header-content col-sm-7 ">
       
            <div id="app" >
                <h1><?php echo $reserva_1 ?> </br><?php echo $reserva_7 ?></h1>
                
                <p><?php echo $reserva_2?></br><?php echo $reserva_3?></br><?php echo $reserva_4?></p>
            
               <div>
                        <a class="badge-link" href="https://build.phonegap.com/apps/2153508/share"><img src="http://www.movivet.tk/admin/img/app-store.png" alt="descargar app"></a>
                        <a class="badge-link" href="https://build.phonegap.com/apps/2153508/share"><img src="http://www.movivet.tk/admin/img/app-store-01.png"alt="dscargar app "></a>
                    </div>
            </div>
    ...
    <div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight" id="home-3">
							<div class="form-wrap">
								<div class="tab">
									
									<div class="tab-content" >
										<div class="tab-content-inner active" data-content="signup">
											<h3><?php echo $reserva_5?></h3>
                                            <p><?php echo $reserva_10?> <a class="badge-link" href="http://movivet.tk/registro.php"><?php echo $reserva_11?></a> <?php echo $reserva_12?> <a class="badge-link" href="http://movivet.tk/sesion.php"><?php echo $reserva_13?></a>.</p>
											<form action="reservar.php" method="post" onSubmit="return validar();">
												
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start"><?php echo $reserva_8?></label>
														<input type="date" id="fecha" name="fecha" min="2016-11-21" max="2016-12-20"  step="1"  size="30" value="2016-11-21" class="form-control">
													</div>
												</div>
												<div class="row form-group">
													<div class="col-md-12">
														<label for="date-start"><?php echo $reserva_9?></label>
														<input type="time" id="hora" name="hora" value="09:00:00" max="18:00:00" min="09:00:00" class="form-control">
													</div>
												</div>

												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-xl"  value="<?php echo $reserva_6?>">
													</div>
												</div>
											</form>	
										</div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group formu">
                                    <input type="text" class="form-control" placeholder="<?php echo $contacto_5?>" id="name" required data-validation-required-message="Please enter your name." >
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group formu">
                                    <input type="email" class="form-control" placeholder="<?php echo $contacto_6?>" id="email" required data-validation-required-message="Please enter your email address." >
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group formu">
                                    <input type="tel" class="form-control" placeholder="<?php echo $contacto_7?>" id="phone" required data-validation-required-message="Please enter your phone number." >
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group formu">
                                    <input class="form-control" placeholder="<?php echo $contacto_8?>" id="message" required data-validation-required-message="Please enter a message." ></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
