...
<head>
    ...
    <meta name="description" content="Veterinaria Movil a Domicilio">
    <meta name="author" content="Estefania De Angelis">
    <meta name="keywords" content="veterinaria,movil,domicilio,movivet">
...
<body id="page-top">
 ...
 <div><p><?php echo $encabezado_1 ?> </p></div>
   ...
   <section id="servicios">
        ...
        <?php @require 'content/servicioslinks.php'; ?>
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center margin1">
                    <h2 class="section-heading"><?php echo $servicios_1?></h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <img src="http://www.movivet.tk/admin/img/servicios.png" class="img-responsive" alt="servicios">
            
            
           <ul style="font-size:18px; list-style:none">
           <li><a class="page-scroll" href="<?php echo $servicioslinks_4 ?>"><?php echo $servicios_4 ?></a></li>
            <li><a class="page-scroll" href="<?php echo $servicioslinks_5 ?>"><?php echo $servicios_5 ?></a></li>
             <li><a class="page-scroll" href="<?php echo $servicioslinks_6 ?>"><?php echo $servicios_6 ?></a></li>
              <li><a class="page-scroll" href="<?php echo $servicioslinks_7 ?>"><?php echo $servicios_7 ?></a></li>
           </ul>
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                <div> <h2> <?php echo $servicios_2 ?></h2>  </div>
                <a href="<?php echo $servicioslinks_3 ?>" class="btn btn-default btn-xl sr-button"><?php echo $servicios_3 ?> </a>
            </div>
        </div>
    </aside>
